...
func (n *V1Session) computeKeyExchangeKey() (err error) {
	if NTLMSSP_NEGOTIATE_EXTENDED_SESSIONSECURITY.IsSet(n.NegotiateFlags) {
		n.keyExchangeKey = hmac_MD5(n.sessionBaseKey, concat(n.serverChallenge, n.lmChallengeResponse[0:8]))
	} else {
...
func (n *V1ServerSession) GssEncrypt(s []byte) []byte {
	return nil
}

func (n *V1ServerSession) GssDecrypt(s []byte) []byte {
	return nil
}
